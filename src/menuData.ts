...
import Antipasto from './Antipasto.jpg';
import BéarnaiseChicken from './Béarnaise-Chicken.jpg';
import BeefTenderloinTartare from './Beef-Tenderloin-Tartare.jpg';
import Burger from './Burger.jpg';
import BurrataBruschetta from './Burrata_Bruschetta.jpg';
import CountryChickenSalad from './Country-Chicken-Salad.jpg';
import Desserts from './Desserts.jpg';
import DrinksWines from './Drinks & Wines.jpg';
import HorseBlackWhite from './Horse Black & White.jpg';
import HotWings from './Hot-Wings.jpg';
import IceCreamDessert from './Ice Cream Dessert.jpg';
import MinuteSteak from './Minute Steak.jpg';
import Pannacotta from './Pannacotta.jpg';
import PastaAllaNorma from './Pasta-alla-Norma.jpg';
import PastaConPollo from './Pasta-con-Pollo.jpg';
import PastaDiManzo from './Pasta-di-Manzo.jpg';
import PatatasBravas from './Patatas_Bravas.jpg';
import PepperSteak from './Pepper Steak.jpg';
import PetiteTender from './Petite Tender.jpg';
import PorkChop from './Pork Chop.jpg';
import Sgroppino from './Sgroppino.jpg';
import ShrimpToast from './Shrimp_Toast.jpg';
import SomethingSimple from './Something-Simple.jpg';
import TarteFlambée from './Tarte-Flambée.jpg';
import WhiteChocolateRhubarb from './White Chocolate & Rhubarb.jpg';
import Whitefish from './Whitefish.jpg';
...
export const DIET_INFO: Record<DietKey, { fi: string; en: string }> = {
  ...
  V: { fi: 'Vegaanisena saatayalda', en: 'Available as vegan' },
};
...
export const CATEGORIES: Category[] = [
    ...
    dishes: [
      {
        ...
        price: '7',
        descFi: 'Mausteisia perunoita, Yaldan tomaattikastiketta ja aiolia.',
        descEn: "Crispy spiced potatoes, Yalda's tomato sauce and aioli.",
        diets: ['L'],
        optionalDiets: ['G', 'V'],
      ...
      },
      {
        ...
        image: BurrataBruschetta,
      },
      {
        id: 'katkaraputoast',
        name: { fi: 'Yaldan katkaraputoast', en: "Yalda's Shrimp Toast" },
        price: '12',
  ...
  },
  {
    ...
    dishes: [
      ...
      {
        id: 'yalda-burger',
        name: { fi: 'Yalda Burger', en: 'Yalda Burger' },
        price: '20',
        descFi: 'Briossisämpylä, naudan jauhelihapihvi, pekonia, cheddaria, rucolaa, tomaattia, pikkelöityä punasipulia, Yaldan BBQ-majoneesia, ranskalaisia ja ranch-dippiä. Saatavana myös vegaanisena.',
        descEn: "Brioche bun, beef patty, bacon, cheddar, rocket salad, tomato, pickled red onion, Yalda's BBQ-mayonnaise, french fries and ranch dip. Also available as vegan.",
        diets: ['L'],
        optionalDiets: ['G', 'V'],
        wine: { name: 'Wagram Pinot Noir, Austria', price: '10,80 € / 12 cl' },
        image: Burger, 
      },
      {
        ...
        price: '18',
        descFi: '15kpl broilerin siipiä, porkkana- ja kurkkutikkuja sekä Yaldan aurajuustodippiä. Ranskalaisia ja ranch-dippiä. Valitse medium- tai hotkastike. Saatavana myös vegaanisena.',
        descEn: "15 pieces of chicken wings, carrot and cucumber sticks with Yalda's blue cheese dip. French fries and ranch dip. Choose medium or hot sauce. Also available as vegan.",
        diets: ['L'],
        optionalDiets: ['G', 'V'],
      ...
      },
      {
        ...
        price: '21',
        descFi: 'Valikoima juustoja ja leikkeleitä, Yaldan marinoituja oliiveja, artisokkaa, tomaattichutneyta ja juustoflambeeta.',
  ...
  },
  {
    ...
    dishes: [
      ...
      {
        id: 'lehtipihvi',
        name: { fi: 'Yaldan lehtipihvi', en: "Yalda's Minute Steak" },
        price: '26',
      ...
      {
        id: 'possu',
        name: { fi: 'Yaldan Possu', en: "Yalda's Pork Chop" },
        price: '22',
